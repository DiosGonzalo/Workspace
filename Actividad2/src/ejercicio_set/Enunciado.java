...
Buscar un instrumento por código, devolviendo el instrumento.

Encontrar el instrumento más barato.

Eliminar un instrumento por código.

Modificar el precio de un instrumento elegido por el usuario.

Mostrar todos los instrumentos en stock usando for-each.
Crear una clase principal con un menú repetitivo para probar las funcionalidades, inicializando el Set con algunos instrumentos de prueba. Usar solo el API de Java. Nota: HashSet no permite ordenación.
